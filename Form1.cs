...
namespace A_Player
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (pausePlay)
            {
                button2.Image = Image.FromFile("C:\\Users\\krend\\Documents\\Visual Studio 2015\\Projects\\audio_player_PI_15_B\\audio_player_PI_15_B\\pause.bmp");
                wmp.controls.pause();
                label1.Text = "Пауза:";
            ...
            if (!pausePlay)
            {
                button2.Image = Image.FromFile("C:\\Users\\krend\\Documents\\Visual Studio 2015\\Projects\\audio_player_PI_15_B\\audio_player_PI_15_B\\play.bmp");
                wmp.controls.play();
                label1.Text = "Сейчас играет:";  
            }
